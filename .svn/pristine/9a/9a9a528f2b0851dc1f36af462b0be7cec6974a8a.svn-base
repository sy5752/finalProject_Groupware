                       ...
                       <p> Login to access your account.</p>
                        ...
                        <form action="${cp}/empController/loginProcess" method="post" class="form-horizontal" role="form">
                            <div class="form-group">
                                <div class="col-md-12">
	                                <input type="text" class="form-control" id="email" name="emp_id" placeholder="아이디를입력해주세요.">
<!--                                     <input type="text" class="form-control" id="emp_id" name="emp_id" placeholder="empid"> -->
                            ...
                            <div class="form-group">
                               <div class="col-md-12">
                                    <input type="password" class="form-control" id="password" name="pass" placeholder="비밀번호를입력해주세요.">
